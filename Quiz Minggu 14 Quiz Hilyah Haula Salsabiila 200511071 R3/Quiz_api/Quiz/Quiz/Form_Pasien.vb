...
Public Class Form_Pasien
    ...
    Private Sub txtTgl_lahir_TextChanged(sender As Object, e As EventArgs) Handles txtTgl_lahir.TextChanged
    ...
    Private Sub txtNRP_TextChanged(sender As Object, e As EventArgs) Handles txtNRP.TextChanged
