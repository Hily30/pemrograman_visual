...
Public Class Form_transaksi
    Private Sub btnHitung_Click(sender As Object, e As EventArgs) Handles btnHitung.Click
        ...
        If Integer.TryParse(txtJumlah_barang.Text, jumlah_barang) AndAlso Integer.TryParse(txtHarga.Text, harga) Then

            Dim total_harga As Integer = jumlah_barang * harga

            txtTotal_harga.Text = total_harga.ToString()
    ...
    Private Sub TambahData()
        ...
        Dim jumlah_barang As String = txtJumlah_barang.Text
        Dim harga As String = txtHarga.Text
        Dim total_harga As String = txtTotal_harga.Text

        Dim postData As String = $"kode_transaksi={kode_transaksi}&kode_barang={kode_barang}&kode_pelanggan={kode_pelanggan}&jumlah_barang={jumlah_barang}&harga={harga}&total_harga={total_harga}"
                ...
                Finally
                    If (transaksi_baru = False) Then
                        ...
                        For Each mydata As Transaksi In data
                            ...
                            txtJumlah_barang.Text = mydata.jumlah_barang
                            txtTotal_harga.Text = mydata.total_harga
                        Next
                    End If
